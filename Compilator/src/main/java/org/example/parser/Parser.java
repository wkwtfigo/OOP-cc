package org.example.parser;/* A Bison parser, made by GNU Bison 3.8.2.  */
...
public class Parser
{
  ...
  public enum SymbolKind
  {
    ...
    S_type_with_args(44),          /* type_with_args  */
    ...
    S_member_access(65),           /* member_access  */
    S_print_statement(66),         /* print_statement  */
    S_primary(67),                 /* primary  */
    S_constructor_invocation(68),  /* constructor_invocation  */
    S_function_call(69),           /* function_call  */
    S_argument_list_opt(70),       /* argument_list_opt  */
    S_argument_list(71);           /* argument_list  */
  ...
  "type_with_args", "method_declaration", "method_header",
  ...
  "return_statement", "optional_expression", "expression", "member_access",
  "print_statement", "primary", "constructor_invocation", "function_call",
...
/* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
  ...
  private static final byte[] yypact_init()
  {
    return new byte[]
    {
     -81,    23,     5,   -81,    17,   -81,    21,    22,    33,   -81,
     -81,     8,   -81,    26,    27,    18,   -81,   -81,   -81,    -1,
     -81,     1,    30,    30,    25,    10,   -81,   -81,    31,    28,
      29,    24,   -81,    20,    10,    10,    10,    10,    34,   -81,
      45,    25,   -81,   -81,   -81,   -81,   -81,   -81,   -81,   -81,
      32,   -81,   -81,   -81,     9,   -81,   -81,   -81,   -81,    35,
     -81,    37,    39,   -81,    30,    47,    -6,     0,   -81,     9,
       9,    10,   -81,   -81,    10,    41,    10,    10,   -81,   -81,
     -81,    25,    25,    25,     9,     9,    36,    40,   -81,    43,
      44,    54,    55,    49,   -81,    10,   -81,   -81,   -81,   -81,
      25,    59,     9,   -81,   -81
    };
  }
...
/* YYDEFACT[STATE-NUM] -- Default reduction number in state STATE-NUM.
  ...
  private static final byte[] yydefact_init()
  {
    ...
    {
       3,     0,     2,     1,     0,     4,     6,     0,     0,     7,
       8,     0,     5,     0,     0,     0,     9,    10,    11,    18,
      12,     0,    22,    22,    30,     0,    16,    19,     0,     0,
      27,    23,    24,     0,     0,     0,    47,     0,     0,    35,
       0,    31,    32,    34,    36,    37,    38,    39,    40,    58,
       0,    55,    56,    57,    21,    52,    49,    50,    51,    14,
      13,     0,     0,    17,     0,     0,     0,     0,    46,    48,
      54,     0,    20,    33,    61,     0,    61,    61,    26,    28,
      25,    30,    30,    30,    41,    63,     0,    62,    53,     0,
       0,     0,     0,    44,    59,     0,    60,    15,    29,    42,
      30,     0,    64,    45,    43
    };
  }
...
/* YYPGOTO[NTERM-NUM].  */
  ...
  private static final byte[] yypgoto_init()
  {
    return new byte[]
    {
     ...
     -81,   -81,   -81,    46,   -81,     4,   -81,   -81,   -80,   -81,
      38,   -81,   -81,   -81,   -81,   -81,   -81,   -81,   -25,   -81,
     -81,   -81,   -81,   -81,   -70,   -81
    };
  }
...
/* YYDEFGOTO[NTERM-NUM].  */
  ...
  private static final byte[] yydefgoto_init()
  {
    return new byte[]
    {
       0,     1,     2,     5,     8,    11,    16,    39,    60,    18,
      19,    26,    27,    30,    31,    32,    63,    20,    40,    41,
      42,    43,    44,    45,    46,   101,    47,    68,    85,    55,
      48,    56,    57,    58,    86,    87
    };
  }
...
/* YYTABLE[YYPACT[STATE-NUM]] -- What to do in state STATE-NUM.  If
  ...
  private static final byte[] yytable_init()
  {
    return new byte[]
    {
      54,    91,    92,    93,    24,    82,    89,    90,     4,    66,
      67,    69,    70,    83,    12,    13,    14,    15,    75,    49,
     103,    76,    25,     3,    75,     7,    28,    76,    50,    51,
      52,    53,    13,    75,     6,    34,    76,    35,    10,     9,
      36,    37,    38,    21,    22,    23,    84,    29,    65,    59,
      64,    72,    81,    61,    62,    78,    71,    79,    88,    74,
      98,    99,    77,   100,    94,   104,    95,    17,    80,    33,
     102,    96,    97,     0,     0,     0,     0,     0,     0,    73
    };
  }
...
private static final byte[] yycheck_ = yycheck_init();
  private static final byte[] yycheck_init()
  {
    return new byte[]
    {
      25,    81,    82,    83,     5,    11,    76,    77,     3,    34,
      35,    36,    37,    13,     6,     7,     8,     9,    24,     9,
     100,    27,    23,     0,    24,     4,    25,    27,    18,    19,
      20,    21,     7,    24,    17,    10,    27,    12,     5,    17,
      15,    16,    17,    17,    17,    27,    71,    17,    28,    18,
      26,     6,     5,    25,    25,    18,    22,    18,    17,    27,
       6,     6,    27,    14,    28,     6,    26,    11,    64,    23,
      95,    28,    28,    -1,    -1,    -1,    -1,    -1,    -1,    41
    };
  }
...
/* YYSTOS[STATE-NUM] -- The symbol kind of the accessing symbol of
  ...
  private static final byte[] yystos_init()
  {
    return new byte[]
    {
       0,    37,    38,     0,     3,    39,    17,     4,    40,    17,
       5,    41,     6,     7,     8,     9,    42,    43,    45,    46,
      53,    17,    17,    27,     5,    23,    47,    48,    25,    17,
      49,    50,    51,    49,    10,    12,    15,    16,    17,    43,
      54,    55,    56,    57,    58,    59,    60,    62,    66,     9,
      18,    19,    20,    21,    64,    65,    67,    68,    69,    18,
      44,    25,    25,    52,    26,    28,    64,    64,    63,    64,
      64,    22,     6,    56,    27,    24,    27,    27,    18,    18,
      51,     5,    11,    13,    64,    64,    70,    71,    17,    70,
      70,    54,    54,    54,    28,    26,    28,    28,     6,     6,
      14,    61,    64,    54,     6
    };
  }
