...
public class Parser
{
  ...
  if (yyn == 55)
    /* "parser.y":181  */
                  { yyval = new IntLiteralNode((Integer)yystack.valueAt (0)); };
  break;
  ...
  if (yyn == 56)
    /* "parser.y":182  */
                   { yyval = new RealLiteralNode((Double)yystack.valueAt (0)); };
  break;
  ...
  if (yyn == 57)
    /* "parser.y":183  */
                   { yyval = new BoolLiteralNode((Boolean)yystack.valueAt (0)); };
  break;
