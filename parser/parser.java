...
class MyParser
{
  ...
  public enum SymbolKind
  {
    ...
    S_TOK_ID(17),                  /* TOK_ID  */
    S_TOK_INT_LIT(18),             /* TOK_INT_LIT  */
    S_TOK_REAL_LIT(19),            /* TOK_REAL_LIT  */
    S_TOK_BOOL_LIT(20),            /* TOK_BOOL_LIT  */
    S_TOK_ASSIGN(21),              /* TOK_ASSIGN  */
    S_TOK_ARROW(22),               /* TOK_ARROW  */
    S_TOK_DOT(23),                 /* TOK_DOT  */
    S_TOK_COLON(24),               /* TOK_COLON  */
    S_TOK_COMMA(25),               /* TOK_COMMA  */
    S_TOK_LPAR(26),                /* TOK_LPAR  */
    S_TOK_RPAR(27),                /* TOK_RPAR  */
    S_TOK_LBRACK(28),              /* TOK_LBRACK  */
    S_TOK_RBRACK(29),              /* TOK_RBRACK  */
    S_TOK_LBRACE(30),              /* TOK_LBRACE  */
    S_TOK_RBRACE(31),              /* TOK_RBRACE  */
    S_TOK_LT(32),                  /* TOK_LT  */
    S_TOK_RT(33),                  /* TOK_RT  */
    S_TOK_EOF(34),                 /* TOK_EOF  */
    S_YYACCEPT(35),                /* $accept  */
    S_program(36),                 /* program  */
    S_class_list(37),              /* class_list  */
    S_class_declaration(38),       /* class_declaration  */
    S_class_name(39),              /* class_name  */
    S_optional_generic_params(40), /* optional_generic_params  */
    S_type_list(41),               /* type_list  */
    ...
    S_method_declaration(46),      /* method_declaration  */
    S_method_header(47),           /* method_header  */
    S_optional_method_body(48),    /* optional_method_body  */
    S_method_body(49),             /* method_body  */
    S_optional_parameters(50),     /* optional_parameters  */
    S_parameters(51),              /* parameters  */
    ...
    S_optional_expression(63),     /* optional_expression  */
    S_expression(64),              /* expression  */
    S_print_statement(65),         /* print_statement  */
    S_primary(66),                 /* primary  */
    S_constructor_invocation(67),  /* constructor_invocation  */
    S_function_call(68),           /* function_call  */
    S_optional_arguments(69),      /* optional_arguments  */
    S_arguments(70),               /* arguments  */
    S_arg_list(71),                /* arg_list  */
    S_arg_list_tail(72);           /* arg_list_tail  */
    ...
    private static final SymbolKind[] values_ = {
      ...
      SymbolKind.S_optional_generic_params,
      SymbolKind.S_type_list,
      ...
      SymbolKind.S_optional_expression,
  ...
  "TOK_PRINT", "TOK_ID", "TOK_INT_LIT", "TOK_REAL_LIT", "TOK_BOOL_LIT",
  "TOK_ASSIGN", "TOK_ARROW", "TOK_DOT", "TOK_COLON", "TOK_COMMA",
  "TOK_LPAR", "TOK_RPAR", "TOK_LBRACK", "TOK_RBRACK", "TOK_LBRACE",
  "TOK_RBRACE", "TOK_LT", "TOK_RT", "TOK_EOF", "$accept", "program",
  "class_list", "class_declaration", "class_name",
  "optional_generic_params", "type_list", "optional_extends",
  "member_list", "member_declaration", "variable_declaration",
  "method_declaration", "method_header", "optional_method_body",
  "method_body", "optional_parameters", "parameters", "parameter_list",
  "parameter_declaration", "optional_return_type",
  "constructor_declaration", "body", "statement", "assignment",
  "while_loop", "if_statement", "optional_else", "return_statement",
  "optional_expression", "expression", "print_statement", "primary",
  "constructor_invocation", "function_call", "optional_arguments",
  "arguments", "arg_list", "arg_list_tail", null
    };
  }
...
/* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
  ...
  private static final byte[] yypact_init()
  {
    return new byte[]
    {
     -45,     8,     4,   -45,     3,   -45,     5,    33,    39,   -45,
      46,    60,   -45,     7,   -45,   -45,    49,   -45,    40,   -45,
     -45,    55,    56,    51,   -45,   -45,   -45,     0,   -45,    54,
      51,    14,    70,   -45,   -45,     6,   -45,   -45,     6,    59,
      62,   -45,    27,   -45,   -45,    28,   -45,   -45,   -45,   -45,
      58,   -10,   -45,   -45,   -45,   -10,     3,   -45,     3,    71,
     -45,    52,   -45,     6,     6,     6,     6,    73,   -45,   -45,
     -45,   -45,   -45,   -45,   -45,    -8,   -45,   -45,     6,   -45,
     -45,   -45,   -45,   -45,    -5,    -9,   -45,   -10,   -10,     6,
     -45,    74,    68,   -10,   -45,   -45,   -10,     6,   -45,   -45,
      64,    75,    74,   -45,   -45,    98,   -45,    86,   -45
    };
  }
...
/* YYDEFACT[STATE-NUM] -- Default reduction number in state STATE-NUM.
  ...
  private static final byte[] yydefact_init()
  {
    return new byte[]
    {
       3,     0,     2,     1,     0,     4,     7,    11,     0,     6,
       0,     0,     9,     0,    12,    13,     0,     8,     0,    10,
       5,     0,     0,    25,    14,    15,    16,    21,    17,     0,
      25,     0,     0,    26,    35,     0,    19,    22,     0,    32,
       0,    28,     0,    29,    35,     0,    59,    56,    57,    58,
       0,    24,    51,    52,    53,    18,     0,    20,     0,     0,
      27,     0,    23,     0,     0,    49,     0,     0,    37,    36,
      38,    39,    40,    41,    42,     0,    60,    62,     0,    61,
      33,    31,    30,    34,     0,     0,    48,    50,    55,     0,
      63,    66,     0,    54,    35,    35,    43,     0,    65,    64,
       0,    46,    66,    44,    35,     0,    67,    47,    45
    };
  }
  ...
  private static final byte[] yypgoto_init()
  {
    return new byte[]
    {
     -45,   -45,   -45,   -45,    -1,   -45,   -45,   -45,   -45,   -45,
      87,   -45,   -45,   -45,   -45,    76,   -45,   -45,    48,   -45,
     -45,   -44,   -45,   -45,   -45,   -45,   -45,   -45,   -45,   -36,
     -45,   -45,   -45,   -45,    61,   -45,   -45,    10
    };
  }
...
/* YYDEFGOTO[NTERM-NUM].  */
  ...
  private static final byte[] yydefgoto_init()
  {
    return new byte[]
    {
       0,     1,     2,     5,    50,     9,    13,    11,    18,    24,
      68,    26,    27,    36,    37,    32,    33,    42,    43,    57,
      28,    45,    69,    70,    71,    72,   105,    73,    86,    51,
      74,    52,    53,    54,    79,    77,    92,    98
    };
  }
...
/* YYTABLE[YYPACT[STATE-NUM]] -- What to do in state STATE-NUM.  If
  ...
  private static final byte[] yytable_init()
  {
    return new byte[]
    {
      61,    46,    55,     7,    95,    34,    94,     4,     3,     6,
      47,    48,    49,    78,    78,    46,    75,    75,    78,    90,
       6,    75,    35,     6,    47,    48,    49,    84,    85,    87,
      88,    40,    16,     8,    62,    21,    17,    10,    63,    91,
      64,    41,    93,    65,    66,    67,    20,    21,    22,    23,
     100,   101,    59,    96,    60,    80,    12,    81,    83,    21,
     107,   102,    63,    14,    64,    15,    19,    65,    66,    67,
     103,    21,    29,    30,    63,    44,    64,    31,    38,    65,
      66,    67,    21,    56,    75,    63,    58,    64,    40,   104,
      65,    66,    67,    21,    89,    99,    63,    78,    64,    97,
      75,    65,    66,    67,   108,    25,    39,    82,     0,     0,
       0,    76,   106
    };
  }
...
private static final byte[] yycheck_ = yycheck_init();
  private static final byte[] yycheck_init()
  {
    return new byte[]
    {
      44,     9,    38,     4,    13,     5,    11,     3,     0,    17,
      18,    19,    20,    23,    23,     9,    26,    26,    23,    27,
      17,    26,    22,    17,    18,    19,    20,    63,    64,    65,
      66,    17,    25,    28,     6,     7,    29,     4,    10,    75,
      12,    27,    78,    15,    16,    17,     6,     7,     8,     9,
      94,    95,    25,    89,    27,    56,    17,    58,     6,     7,
     104,    97,    10,    17,    12,     5,    17,    15,    16,    17,
       6,     7,    17,    17,    10,     5,    12,    26,    24,    15,
      16,    17,     7,    24,    26,    10,    24,    12,    17,    14,
      15,    16,    17,     7,    21,    27,    10,    23,    12,    25,
      26,    15,    16,    17,     6,    18,    30,    59,    -1,    -1,
      -1,    50,   102
    };
  }
...
/* YYSTOS[STATE-NUM] -- The symbol kind of the accessing symbol of
  ...
  private static final byte[] yystos_init()
  {
    return new byte[]
    {
       0,    36,    37,     0,     3,    38,    17,    39,    28,    40,
       4,    42,    17,    41,    17,     5,    25,    29,    43,    17,
       6,     7,     8,     9,    44,    45,    46,    47,    55,    17,
      17,    26,    50,    51,     5,    22,    48,    49,    24,    50,
      17,    27,    52,    53,     5,    56,     9,    18,    19,    20,
      39,    64,    66,    67,    68,    64,    24,    54,    24,    25,
      27,    56,     6,    10,    12,    15,    16,    17,    45,    57,
      58,    59,    60,    62,    65,    26,    69,    70,    23,    69,
      39,    39,    53,     6,    64,    64,    63,    64,    64,    21,
      27,    64,    71,    64,    11,    13,    64,    25,    72,    27,
      56,    56,    64,     6,    14,    61,    72,    56,     6
    };
  }
